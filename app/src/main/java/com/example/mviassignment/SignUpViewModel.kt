...
//    private val viewState = SignUpViewState()
    ...
    private fun updateSignUpFields(
        ...
        var fullName : String = current.fullName.value
        var email : String =  current.email.value
        var password : String =  current.password.value
        var confirmPassword : String =  current.confirmPassword.value
